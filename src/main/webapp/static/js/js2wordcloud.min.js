            ...
            (function () {
                ...
                (function (global) {
                    ...
                    var WordCloud = function WordCloud(elements, options) {
                        ...
                        var getTextColor;
                        function random_hsl_color(rDiff, rMin, gDiff, gMin, bDiff, bMin) {
                            return 'rgb('+Math.round(Math.random()*rDiff+rMin)+','+Math.round(Math.random()*gDiff+gMin)+','+Math.round(Math.random()*bDiff+bMin)+')';
                        }
                        switch (settings.color) {
                            case 'random-dark':
                                getTextColor = function getRandomDarkColor() {
                                    return random_hsl_color(9, 97, 56, 154, 58 , 177);
                                };
                                break;
