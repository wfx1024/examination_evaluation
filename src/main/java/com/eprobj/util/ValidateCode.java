...
public class ValidateCode {
 ...
 public static final String PASSWORD = "(?![a-zA-z]+$)(?!\\d+$)(?![!@#$%^&*\\-\\+]+$){6,15}[a-zA-Z\\d!@#$%^&*\\-\\+]{6,15}";
 public static final String PASSWORD_2 = "(?:\\d+|[a-zA-Z]+|[!@#$%^&*]+)";
 public static final String ACCOUNT = "(?!_)(?!.*?_$)[a-zA-Z0-9_\\u4e00-\\u9fa5]{1,15}";
 public static final String USERNAME = ".{0,16}";
 ...
 public static BufferedImage generateImageCode(String textCode, int width, int height, int interLine,
  ...
  int fx = height - fsize;
  int fy = fsize;
  g.setFont(new Font("Verdana", Font.PLAIN, fsize));
  // 写验证码字符
